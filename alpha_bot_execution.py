    ...
    try:
        ...
        for account, symphonies in symphony_data_cache.items():
            for sym in symphonies:
                ...
                if velocity_squeeze < 1.0:
                    should_arm = True
                    arm_reason = f"Parabolic Squeeze ({velocity_squeeze:.2f}x)"
                elif TAKE_PROFIT_MC_PCT <= prob_beating < TRIGGER_THRESHOLD_PCT:
                    should_arm = True
                ...
                if is_vwap_broken:
                    ...
                    if is_trailing_stop_hit and velocity_squeeze < 1.0:
                        chart_event = "Parabolic"
                    else:
                ...
                if is_trailing_stop_hit or tp_triggered_now or is_vwap_broken:
                    ...
                    elif velocity_squeeze < 1.0:
                        reason = "Parabolic Stop"
                    else:
